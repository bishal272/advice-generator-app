...
function Advice() {
  ...
  return (
    <div className="parent">
      ...
      <button className='child3' aria-label="nextbtn" aria-labelledby="labelnext" value={""} role="next"><img src="/images/icon-dice.svg" className='btn' alt="" onClick={handleClick} /></button>
